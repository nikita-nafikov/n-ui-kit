...
<template>
  <NCollapse />
      ...
      description: {
        component: 'Use Collapse to store contents.',
      },
    },
  },
  argTypes: {
...
} as Meta<typeof NCollapse>;

const Template: StoryFn<typeof NCollapse> = args => ({
  components: { NCollapse },
  setup() {
    return { args };
  },
  template: `
...
Default.args = {
  title: 'NCollapse Title',
  default: 'NCollapse Content',
  isDarkTheme: false,
};

export const WithCustomHeaderAndContent = Template.bind({});
...
WithCustomHeaderAndContent.parameters = {
  docs: {
    disable: true,
  },
};
