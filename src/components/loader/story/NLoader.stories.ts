...
<template>
  <NLoader show="isLoaderShow">NLoader Content...</NLoader>
      ...
      description: {
        component: 'Show animation while loading data.',
      },
    },
  },
  argTypes: {
...
} as Meta<typeof NLoader>;

const Template: StoryFn<typeof NLoader> = args => ({
  components: { NLoader },
  setup() {
    return { args };
  },
...
Default.args = {
  show: true,
  default: 'NLoader Content...',
};

export const WithCustomSpin = Template.bind({});
WithCustomSpin.args = {
  default: 'Custom spin',
  show: true,
  customSpin: `
