...
<template>
  <NTabs>
    ...
    <NTab title="Third Tab">
      ...
      description: {
        component: 'Divide data collections which are related yet belong to different types.',
      },
    },
  },
  argTypes: {
...
} as Meta<typeof NTabs>;

const Template: StoryFn<typeof NTabs> = args => ({
...
export const WithCustomTabsTitle = Template.bind({});
WithCustomTabsTitle.args = {
  title: `
  <div style="display: flex; gap: 4px; align-items: center;">
       <svg
    xmlns="http://www.w3.org/2000/svg"
...
WithCustomTabsTitle.parameters = {
  docs: {
    disable: true,
  },
};
